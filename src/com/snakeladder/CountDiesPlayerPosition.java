...
public class CountDiesPlayerPosition {
    public static void main(String[] args) {
        ...
        do {
            ...
            if (player_position > winning_position){
                player_position =player_position -dieRoll;
                System.out.println("Position goes beyond 100 ..Player stays in the same position");
                System.out.println("Player current position : "+player_position);
                System.out.println("The number required player : "+(winning_position -player_position));
            }
        }
        while (player_position !=winning_position );
        System.out.println("Player reaches the exact winning Position");
        System.out.println("number of times the dice rolled : "+count);
        }
    }
